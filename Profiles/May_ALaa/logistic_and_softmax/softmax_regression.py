...
class SoftmaxRegression(object):
    def __init__(self, learning_rate=0.01, epochs=50,num_of_classes = 3):
        self.__epochs= epochs
        self.__learning_rate = learning_rate
        self.__num_of_classes = num_of_classes

    def fit(self, X, y):
        self.w_ = np.zeros((X.shape[1], self.__num_of_classes))
...
lr = SoftmaxRegression(learning_rate=0.001, epochs=500,num_of_classes=3)
